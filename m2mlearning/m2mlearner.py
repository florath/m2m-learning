...
class Qnetwork():
    def __init__(self,h_size):
        ...
        self.AW = tf.Variable(xavier_init([h_size//2, env.action_space_size()]))
        ...
        self.actions_onehot = tf.one_hot(self.actions,env.action_space_size(), dtype=tf.float32)
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        while rAll < 1000 and steps_in_episode < 50000: # Run until the score is 1000 ; additional abort: if the net gets only penalty
            j+=1
